...
![Type](https://img.shields.io/badge/Type-Project_Management-blue)
![Level](https://img.shields.io/badge/Level-Master_1-orange)
...
| :--- | :--- | :--- |
| **Front-end** | ![React](https://img.shields.io/badge/-React-61DAFB?logo=react&logoColor=white) | Expérience utilisateur fluide et composants réutilisables. |
| **Back-end** | ![NodeJS](https://img.shields.io/badge/-Node.js-339933?logo=node.js&logoColor=white) | Gestion performante des I/O (Imports CSV massifs). |
| **Database** | ![PostgreSQL](https://img.shields.io/badge/-PostgreSQL-336791?logo=postgresql&logoColor=white) | Robustesse et intégrité des données relationnelles. |
| **Cloud** | ![AWS](https://img.shields.io/badge/-AWS-232F3E?logo=amazon-aws&logoColor=white) | Scalabilité et conformité sécurité. |
